...
public interface PacketManager {
   ...
   * being sent to. If the manager has no packets to send (or chooses not to send
   * a packet) then the return value should be null.
   * 
  ...
  /**
   * Receives a single packet and adds it to the packets being managed if it requires
   * further transfer (i.e., is not at its final destination).
