package cosc201.a2;
/**
 * A basic container class to represent locations in a grid (Java does not have a class
 * with this intended use - the provided classes are intended for key-value pairs).
 * 
