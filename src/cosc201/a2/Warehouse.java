...
public class Warehouse {
  ...
  public int getQueueSize(Location l){
    PacketManager m = getManager(l);
    return m.size();
  }
  ...
  /**
     ...
     * @return
     */
    public static int getRemainingDistance(Location c, Location d){
      int distance = (d.col + d.row) - (c.col + c.row); 
      return distance;
  }
