...
public class PriorityManager implements PacketManager {
    private PriorityQueue<Packet> q = new PriorityQueue<>();
    private Location home;
    private Warehouse warehouse;

    public PriorityManager(Warehouse w, Location l) {
        this.warehouse = w;
        this.home = l;
    ...
    /*
     * method used to when destenation is not in a straight line. 
    ...
    private Packet sendDiagonal(Packet p){
     ...
     /*
     * method used if the destination is in a streight line
     */
